...
public class StartScreenGUI extends JFrame {
	...
	private void addListeners() {
		...
		if (this.gamePlay.isNetworkedGame()) { // Enable timer for networked
												// game
			Timer t = new Timer(1000, new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					StartScreenGUI.this.timerLabel
							.setText("Countdown: " + format(this.time / 60) + ":" + format(this.time % 60));
					if (this.time == 0) {
			...
			t.start();
		} else { // Disable timer for local game
			StartScreenGUI.this.startGameButton.setEnabled(true);
			StartScreenGUI.this.timerLabel.setVisible(false);
	...
	private void initializeComponents() {
		...
		this.timerLabel = new JLabel("Countdown: 00:05");
